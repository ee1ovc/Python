...
# Boolean
# Bool- представлен двумя постоянными значениями False и True.
# Если рассматривать эти значения в числовом контексте True = 1, False = 0
...
b_item_result__subtr = b_item_t - b_item_f

#  53. Вывести b_item_result_subtr в консоль.
print('b_item_result_subtr =', b_item_result__subtr)
...
# % остаток от деления
#
# Для присвоения арифметической операции добавить "="
#
# Пример:
#
# a = a + b
...
# round() - округлить до ближайшего чётного целого
# divmod() - деление нацело и нахождение остатка от деления
# pow() - возводит в степень
# max() - находит максимальный элемент аргумента
# min() - находит минимальный элемент аргумента
# sum() - находит элементов аргумента
...
#
# math.pow(X, Y) - XY. - возведение в степень, где Х число а Y степень
#
